"""
news-sentiment-mcp -- News sentiment trends as an MCP tool. Plug into Claude, Cursor, or any MCP-compatible AI host. Weekly series, growth percentages, and live news feed.
...
SOURCE: TrendsSource = "news sentiment"
